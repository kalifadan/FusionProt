...
if __name__ == "__main__":
    ...
    for i in range(0, cfg.train.num_epoch, step):
        ...
        wandb.log({"epoch": kwargs["num_epoch"]})
        ...
        # before running - create the output path for the models
        save(solver, cfg.output_dir + "/models/model_epoch_%d.pth" % (i + kwargs["num_epoch"]))
