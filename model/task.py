...
@R.register("tasks.HumanInteractionPrediction")
class HumanInteractionPrediction(tasks.InteractionPrediction):

    def __init__(self, model, task, num_mlp_layer=2, graph_construction_model=None, verbose=0):
        super(HumanInteractionPrediction, self).__init__(model, model2=model, task=task, criterion="ce",
                                                         metric=("acc", "mcc"), num_mlp_layer=num_mlp_layer,
                                                         normalization=False,
                                                         num_class=2, graph_construction_model=None,
                                                         verbose=verbose)
